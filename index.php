    ...
    <div class="search-popup">
        <div class="search-popup-container">
            <form role="search" method="get" class="search-form" action="">
                <input type="search" id="search-form-documents" class="search-field" placeholder="Nhập từ khóa ..."
                    value="" name="s" />
                        ...
                        <ul id="navbar"
                            ...
                            <li class="nav-item dropdown" id="menu-list">
                                <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    role="button" aria-expanded="false">Danh Sách</a>
                                <ul class="dropdown-menu animate slide border">
                                    <li>
                                        <a href="Pages/users.html" class="dropdown-item fw-light"><span
                                                class="badge bg-primary">Người Dùng & Nhà Cung Cấp</span></a>
                                    </li>
                                    <li>
