...
<body>
    ...
    <div class="search-popup">
        <div class="search-popup-container">
            <form role="search" method="get" class="search-form" action="">
                <input type="search" id="search-form-documents" class="search-field" placeholder="Nhập từ khóa ..." value="" name="s" />
            ...
            <h5 class="cat-list-title">Tìm kiếm với tên tài liệu, sách, ...</h5>
        </div>
    </div>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
                            <li class="nav-item">
                                <a class="nav-link me-4 active" href="index.php">Trang Chủ</a>
                            </li>
                            <li class="nav-item dropdown" id="menu-list">
                                <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Danh Sách</a>
                                <ul class="dropdown-menu animate slide border">
                                    <li>
                                        <a href="Pages/users.html" class="dropdown-item fw-light"><span class="badge bg-primary">Người Dùng & Nhà Cung Cấp</span></a>
                                    </li>
                                    <li>
                                        <a href="Pages/borrow.html" class="dropdown-item fw-light">
                                            <span class="badge bg-primary">Phiếu Mượn & Trả</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 " href="#" onclick="logout()">Đăng Xuất</a>
                            </li>
                                ...
                                <li class="pe-3">
                                                    ...
                                                    <div class="tabs-listing">
                                                        <nav>
                                                            <div class="nav nav-tabs d-flex justify-content-center" id="nav-tab" role="tablist">
                                                                <button class="nav-link text-capitalize active" id="nav-sign-in-tab" data-bs-toggle="tab" data-bs-target="#nav-sign-in" type="button" role="tab" aria-controls="nav-sign-in" aria-selected="true">Thông tin cá nhân</button>
                                                            </div>
                                                        </nav>
                                    ...
                                    <script>
                                        function handleUpdateSubmit(event) {
                                            ...
                                            let username = document.getElementById("usernameUsers").value;
                                            let diaChi = document.getElementById("diaChiUsers").value;
                                            let dienthoai = document.getElementById("dienThoaiUsers").value;
                                            var updateData = {
                                            ...
                                            xhr.open("POST", "services/userData/updateUserData.php", true);
                                ...
                                <li class="wishlist-dropdown dropdown pe-3">
                                    ...
                                    <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                                        <h4 class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="text-primary">Danh Sách Phiếu Mượn</span>
                                        </h4>
                                        <ul class="list-group mb-3 custom-class">
    ...
    <section id="best-selling-items" class="position-relative padding-large ">
        <div class="container">
            <div class="section-title d-md-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <span id="themTaiLieuBtn" class="btn btn-primary" onClick="themTaiLieu()">Thêm tài liệu</span>
                    <span id="themNhaCungCapBtn" class="btn btn-primary" onClick="themNhaCungCap()">Thêm Nhà Cung
                        Cấp</span>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative text-left p-5 border rounded-3">
                            <blockquote>"I ordered a few books online from this store, and I was impressed by the quick
                                ...
                                definitely be
                                shopping here again!"</blockquote>
                            <div class="rating text-warning d-flex align-items-center">
                                <svg class="star star-fill">
                                    <use xlink:href="#star-fill"></use>
                                </svg>
    ...
    <script>
        ...
        $(".search-form").submit(function(event) {
            event.preventDefault();
            const keyword = $("#search-form-documents").val();
            getTaiLieu(keyword);
        });
